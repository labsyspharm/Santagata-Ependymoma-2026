...
colormap(gca,gray);
set(gca,'color','k');
caxis([log(prctile(datatable{:,channel},1)),log(prctile(datatable{:,channel},99))]);
...
%% Calculate entropy for E_cadherin & TROP2
